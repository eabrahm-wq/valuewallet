...
const NEIGHBORHOODS = ["Mission", "Bernal Heights", "Noe Valley", "Haight"];
      ...
      <div style={{ padding: "16px 16px 0" }}>
        ...
        {locMode === "zip" && (
          <div style={{ display: "flex", gap: 8, marginBottom: 14 }}>
            <input value={zip} onChange={e => setZip(e.target.value)} placeholder="94110, 94112, 94131, 94117" maxLength={5}
            ...
            <button onClick={() => { const m = { "94110": "Mission", "94112": "Bernal Heights", "94131": "Noe Valley", "94117": "Haight" }; if (m[zip]) setNeighborhood(m[zip]); }} style={{ background: T.accent, color: "#fff", border: "none", borderRadius: T.radiusSm, padding: "9px 16px", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>Go</button>
          </div>
        )}
